// ==UserScript==
// @name         Pre Client Remake Minify Unpatched
// @author       eahuha
// @description
// @version      V1
// @require      https://rawgit.com/kawanet/msgpack-lite/master/dist/msgpack.min.js
// @match        *://*.moomoo.io/*
// @match        https://moomoo.skids.info/?server=8:15:0
// @grant        none
// ==/UserScript==
...
window.urName = "ohio";
const ohio = new Audio(""),
    goofy = new Audio(""),
    ohiosong = new Audio(""),
    madeinohio = new Audio(""),
    song1 = new Audio(""),
    song2 = new Audio(""),
    song3 = new Audio("");
! function (e) {
    ...
    s.connect(e, function(error) {
        ...
        if (!error) {
            ...
            me.onclick = r.checkTrusted(function() {
                if (Ee.classList.contains("showing")) {
                    Ee.classList.remove("showing");
                    ge.innerText = "Settings";
                } else {
                    Ee.classList.add("showing");
                    ge.innerText = "Close";
                }
            });
            ...
            we.onclick = r.checkTrusted(function() { an(); });
            r.hookTouchEvents(we);

            Xe.onclick = r.checkTrusted(function() { Fn(); });
            r.hookTouchEvents(Xe);

            (function() {
                for (var i = 0; i < ei.length; ++i) {
                    var t = new Image();
                    t.onload = function() { this.isLoaded = true; };
                    t.src = (ei[i] == "cross")
                        ? "https://cdn.discordapp.com/attachments/1001384433078779927/1041105230374391878/crorrrrrrrrrshairlololol.png"
                        : ".././img/icons/" + ei[i] + ".png";
                    Zn[ei[i]] = t;
                }
            })();
            ...
            if (As) {
                ...
                let rr = [];
                let keys = ["w", "a", "s", "d"];
                for (let t = 0; t < 8; t++) rr.push(keys[Math.floor(Math.random() * keys.length)]);
                Le.value = rr.join("");
            }

            (function() {
                var e = M("native_resolution");
                en(e ? e === "true" : typeof cordova !== "undefined");
                E = M("show_ping") === "true";
                Te.hidden = !E;
                M("moo_moosic") || 0;
                ...
                for (t = 0; t < c.list.length + c.weapons.length; ++t) {
                    (function(e) {
                        ...
                        n.translate(canvas.width / 2, canvas.height / 2);
                        n.imageSmoothingEnabled = n.webkitImageSmoothingEnabled = n.mozImageSmoothingEnabled = false;

                        var s;
                        if (c.weapons[e]) {
                            n.rotate(Math.PI / 4 + Math.PI);
                            var i = new Image();
                            vi[c.weapons[e].src] = i;
                            i.onload = function() {
                                this.isLoaded = true;
                                var ratio = 1 / (this.height / this.width);
                                var scale = c.weapons[e].iPad || 1;
                                n.drawImage(this, -canvas.width * scale * o.iconPad * ratio / 2, -canvas.height * scale * o.iconPad / 2, canvas.width * scale * ratio * o.iconPad, canvas.height * scale * o.iconPad);
                                n.fillStyle = "rgba(0, 0, 70, 0.1)";
                                n.globalCompositeOperation = "source-atop";
                                n.fillRect(-canvas.width / 2, -canvas.height / 2, canvas.width, canvas.height);
                                document.getElementById("actionBarItem" + e).style.backgroundImage = "url(" + canvas.toDataURL() + ")";
                            };
                            i.src = ".././img/weapons/" + c.weapons[e].src + ".png";

                            s = document.getElementById("actionBarItem" + e);
                            s.onmouseover = r.checkTrusted(function() { vt(c.weapons[e], true); });
                            s.onclick = r.checkTrusted(function() { zn(e, true); });
                            r.hookTouchEvents(s);
                        } else {
                            i = Mi(c.list[e - c.weapons.length], true);
                            var a = Math.min(canvas.width - o.iconPadding, i.width);
                            n.globalAlpha = 1;
                            ...
                            document.getElementById("actionBarItem" + e).style.backgroundImage = "url(" + canvas.toDataURL() + ")";
                            s = document.getElementById("actionBarItem" + e);
                            s.onmouseover = r.checkTrusted(function() { vt(c.list[e - c.weapons.length]); });
                            s.onclick = r.checkTrusted(function() { zn(e - c.weapons.length); });
                            r.hookTouchEvents(s);
                        }
                    })(t);
                }
                ...
                Se.checked = j;
                Se.onchange = r.checkTrusted(function(e) { en(e.target.checked); });
                Ie.checked = E;
                Ie.onchange = r.checkTrusted(function(e) {
                    E = Ie.checked;
                    Te.hidden = !E;
                    T("show_ping", E ? "true" : "false");
                });
        ...
        0: nr
            ...
            function Rt(e) {
                s.send("P", Tt[0].sid, e), Tt.splice(0, 1), Et()
            }
            ...
            function Dt(e) {
                s.send("b", N[e].sid), myConfig.clan = N[e].sid, botConfig.botJoin = !0
            }

            function Ut() {
                s.send("L", document.getElementById("allianceInput").value), myConfig.clan = document.getElementById("allianceInput").value, botConfig.botJoin = !0
            }
            ...
            function Jt(e, t) {
                R.alive && (0 == t ? s.send("c", 0, e, 0) : 1 == t && s.send("c", 0, e, 1))
            }
            ...
            function Kt(e, t, n) {
                R.alive && (0 == t ? R.skins[e] ? n ? R.skinIndex != e && s.send("c", 0, e, 0) : s.send("c", 0, e, 0) : (n ? 0 != R.skinIndex && s.send("c", 0, 0, 0) : s.send("c", 0, 0, 0), s.send("c", 1, e, 0)) : 1 == t && (R.tails[e] ? n ? R.tailIndex != e && s.send("c", 0, e, 1) : s.send("c", 0, e, 1) : (n ? 0 != R.tailIndex && s.send("c", 0, 0, 1) : s.send("c", 0, 0, 1), s.send("c", 1, e, 1))))
            }
            ...
            })), !1), be.addEventListener("touchend", r.checkTrusted(bn), !1), be.addEventListener("touchcancel", r.checkTrusted(bn), !1), be.addEventListener("touchleave", r.checkTrusted(bn), !1), mals.addEventListener("mousemove", (function (e) {
                e.preventDefault(), e.stopPropagation(), wn(!1), ne = e.clientX, ie = e.clientY
            }), !1), mals.addEventListener("mousedown", (function (e) {
                wn(!1), 1 != _ && (_ = 1, os = !0, 0 == e.button ? (ls = !0, vn = !0) : 1 == e.button ? (hs = !0, us = !0) : 2 == e.button && (cs = !0))
            }), !1);
            let vn = !1,
                xn = !1;
            var Sn;
            mals.addEventListener("mouseup", (function (e) {
                wn(!1), 0 != _ && (_ = 0, 0 == e.button ? (ls = !1, xn = !0) : 1 == e.button ? hs = !1 : 2 == e.button && (cs = !1), ls || hs || cs || (os = !1))
            }), !1), mals.addEventListener("wheel", (function (e) {
                e.deltaY < 0
            }), !1);
            var In = null,
                Tn = !1;
            ...
            function Ln() {
                ...
                (null == Un || null == e || Math.abs(e - Un) > .3) && (js || s.send("9", e), Un = e, e)
            }
            ...
            function Hn() {
                if (T("moo_name", Le.value), !ce && s.connected) {
                    Ji = 0, ce = !0, v.stop("menu"), ohio.pause(), ohio.currentTime = 0, pt("Loading..."), s.send("M", {
            ...
            function Kn(e) {
                ...
                let t = Zs(e);
                if (Jn) Rs(t, R) <= 111 && (qs(5, jn() - Ws(45)), qs(5, jn() + Ws(45)), s.send("D", jn()));
            ...
            function Hi(e, t) {
                e.sid == R.sid || er(e.sid) || (Yi.bullet++, setTimeout((() => {
                    ...
                    zi = !1
                }), 3e3), V.length >= 3 ? Os(ms, R) <= 300 ? s.send("6", "gay") : s.send("6", "2") : s.send("6", "3")))
            }
            ...
            function qs(e, t) {
                zn(R.items[e]), s.send("F", 1, t), s.send("F", 0, t), zn(Ji, !0)
            }
            ...
            function Ns(e) {
                ...
                }), Vs(), us && (us = !1, Qi = !0, As || s.send("6", "ml, " + R.x2 + ", " + R.y2), s.send("K", 1), Ji = R.weapons[1], zn(R.weapons[1], !0), s.send("D", ks), Kt(53, 0), Xs((() => {
                    Qi = !1, Ys(), s.send("K", 1)
                }), 1)), Cs && (Cs = !1, console.log([R.buildIndex, R.weaponIndex, R.weaponVariant].join(", ")), ms.length && (R.iChatMessage = Ks(ms[0]) + "/" + ms[0], R.iChatCountdown = 3e3, console.log(ms)), kn()), vn && (vn = !1, Jt(0, 1)), xn && (xn = !1, rs || Ki || vs.canInsta ? Jt(0, 1) : Kt(11, 1)), !os || hs || rs || (ls ? (Ki || fs || 1 != R.pR || (fs = !0, s.send("K", 1), Kt(7, 0), Xs((() => {
                    fs = !1, s.send("K", 1), Ys()
                }), 1)), Ji = R.weapons[0], zn(R.weapons[0], !0)) : cs && (Ki || fs || 1 != (10 == R.weapons[1] ? R.sR : R.pR) || (fs = !0, s.send("K", 1), Kt(40, 0), Xs((() => {
                    fs = !1, s.send("K", 1), Ys()
                ...
                if ("pit trap" == ys.name && R.sid != ys.owner.sid && !er(ys.owner.sid) && Rs(ys, R) <= 50 && ys.active) {
                    ...
                    vs.canInsta || Ki || (Ji = e, zn(e, !0)), !rs || vs.canInsta || Ki || fs || (10 == R.weapons[1] && 8 != R.weapons[0] && 2 != ns.hitCount ? 1 != R.sR : 1 != R.pR) || (fs = !0, s.send("K", 1), s.send("D", as), 2 == ns.hitCount ? a.length ? Kt(22, 0) : Kt(6, 0) : Kt(40, 0), Xs((() => {
                        10 == R.weapons[1] && 8 != R.weapons[0] && 2 == ns.hitCount ? (fs = !0, rs ? a.length ? Kt(22, 0) : Kt(6, 0) : Ys(), Xs((() => {
                            s.send("K", 1), fs = !1, Ji = 10 == R.weapons[1] ? R.weapons[1] : R.weapons[0], zn(10 == R.weapons[1] ? R.weapons[1] : R.weapons[0], !0)
                        }), 1)) : (fs = !1, s.send("K", 1), rs ? a.length ? Kt(22, 0) : Kt(6, 0) : Ys())
                    }), 1))
                } else rs = !1;
                if ($i && (R.skins[53] ? R.skins[7] || $t(7, 0) : $t(53, 0)), vs.canInsta && ($i = !1, function () {
                        ...
                        Ki = !0, Qi = !0, !0, Ji = R.weapons[10 == R.weapons[1] ? 1 : 0], zn(R.weapons[10 == R.weapons[1] ? 1 : 0], !0), s.send("D", ks), Kt(10 == R.weapons[1] ? 53 : 7, 0), Jt(0, 1), Yn(), (window.testTick ? Gs : setTimeout)((() => {
                            Ji = R.weapons[10 == R.weapons[1] ? 0 : 1], zn(R.weapons[10 == R.weapons[1] ? 0 : 1], !0), s.send("D", ks), Kt(10 == R.weapons[1] ? 7 : 53, 0), (window.testTick ? Gs : setTimeout)((() => {
                    ...
                    let e = Os(ms, R),
                        t = ks,
                        n = ks + Math.PI;
                    ms.length ? (js = !0, e < 185 ? (Ys(), Bs != n && (Bs = n, s.send("9", n)), -1 != R.buildIndex && (Ji = R.weapons[0], zn(R.weapons[0]))) : e >= 185 && e < 220 ? (Kt(e < 210 ? 22 : 40, 0), Bs != n && (Bs = n, s.send("9", n)), R.buildIndex != R.items[1] && zn(R.items[1])) : e > 230 && e <= 265 ? (Kt(e > 240 ? 22 : 40, 0), Bs != t && (Bs = t, s.send("9", t)), R.buildIndex != R.items[1] && zn(R.items[1])) : e > 265 ? (Ys(), Bs != t && (Bs = t, s.send("9", t)), -1 != R.buildIndex && (Ji = R.weapons[0], zn(R.weapons[0]))) : e >= 220 && e <= 230 && (6 != ms[9] && 22 != ms[9] && 1 == R.pR && 1 == R.tR && Ps ? function () {
                        let e = X.filter((e => "turret" == e.name && R.sid != e.owner.sid && !er(e.owner.sid) && Rs(e, R) <= 700 && e.active));
                        Ms = !1, !0, !0, Qi = !0, Ji = R.weapons[0], zn(R.weapons[0], !0), s.send("D", ks), s.send("9", ks), Kt(53, 0), Jt(11, 1), (window.testTick ? Gs : setTimeout)((() => {
                            Yn(), Ji = R.weapons[0], zn(R.weapons[0], !0), s.send("D", ks), s.send("9", ks), Kt(7, 0), Jt(0, 1), (window.testTick ? Gs : setTimeout)((() => {
                                !1, !1, Qi = !1, s.send("9", void 0), rs ? (Ji = 10 == R.weapons[1] && 8 != R.weapons[0] && 2 != ns.hitCount ? R.weapons[1] : R.weapons[0], zn(10 == R.weapons[1] && 8 != R.weapons[0] && 2 != ns.hitCount ? R.weapons[1] : R.weapons[0], !0), e.length ? Kt(22, 0) : Kt(6, 0), Jt(0, 1)) : (Ys(), Kt(11, 1)), Yn()
                            }), window.testTick ? 1 : 1e3 / o.serverUpdateRate)
                        }), window.testTick ? 1 : 1e3 / o.serverUpdateRate)
                    }() : (Jt(0, 0), null != Bs && (Bs = void 0, s.send("9", void 0)), -1 != R.buildIndex && (Ji = R.weapons[0], zn(R.weapons[0]))))) : js = !1
                } else js = !1;
                if (Es && !rs && 5 == R.weapons[0]) {
                    let e = Os(ms, R),
                        t = ks,
                        n = ks + Math.PI;
                    ms.length ? (!0, e < 360 ? (Ys(), s.send("9", n), -1 != R.buildIndex && (Ji = R.weapons[0], zn(R.weapons[0]))) : e >= 360 && e < 395 ? (Kt(e < 385 ? 22 : 40, 0), s.send("9", n), R.buildIndex != R.items[1] && zn(R.items[1])) : e > 405 && e < 440 ? (Kt(e > 415 ? 22 : 40, 0), s.send("9", t), R.buildIndex != R.items[1] && zn(R.items[1])) : e >= 440 ? (Ys(), s.send("9", t), -1 != R.buildIndex && (Ji = R.weapons[0], zn(R.weapons[0]))) : e >= 395 && e <= 405 && (1 == R.pR && 1 == R.sR && 1 == R.tR ? (qs(4, ks), function () {
                        let e = X.filter((e => "turret" == e.name && R.sid != e.owner.sid && !er(e.owner.sid) && Rs(e, R) <= 700 && e.active));
                        Es = !1, !0, !0, Qi = !0, Yn(), Ji = R.weapons[1], zn(R.weapons[1], !0), s.send("D", ks), s.send("9", ks), Kt(53, 0), Kt(11, 1), (window.testTick ? Gs : setTimeout)((() => {
                            s.send("9", ks), Kt(12, 0), Kt(11, 1), (window.testTick ? Gs : setTimeout)((() => {
                                Ji = R.weapons[0], zn(R.weapons[0], !0), s.send("D", ks), s.send("9", ks), Kt(7, 0), Jt(0, 1), (window.testTick ? Gs : setTimeout)((() => {
                                    !1, !1, Qi = !1, s.send("9", void 0), rs ? (Ji = 10 == R.weapons[1] && 8 != R.weapons[0] && 2 != ns.hitCount ? R.weapons[1] : R.weapons[0], zn(10 == R.weapons[1] && 8 != R.weapons[0] && 2 != ns.hitCount ? R.weapons[1] : R.weapons[0], !0), e.length ? Kt(22, 0) : Kt(6, 0), Jt(0, 1)) : (Ys(), Kt(11, 1)), Yn()
                                }), window.testTick ? 1 : 1e3 / o.serverUpdateRate)
                            }), window.testTick ? 1 : 1e3 / o.serverUpdateRate)
                        }), window.testTick ? 1 : 1e3 / o.serverUpdateRate)
                    }()) : (Jt(0, 0), s.send("9", void 0)))) : js = !1
                } else js = !1;
                ...
                connect: function (e, t, n) {
                    if (!this.socket) {
                        ...
                        try {
                            var r = !1,
                                a = e;
                            this.socket = new OriginalWebSocket(a), this.socket.binaryType = "arraybuffer", this.socket.onmessage = function (e) {
